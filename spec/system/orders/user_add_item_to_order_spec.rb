...
describe 'Usuário adiciona itens ao pedido' do
  ...
  it 'e não vê produtos de outro fornecedor' do
    ...
    warehouse = Warehouse.create!(name: 'Aeroporto SP', code: 'GRU', city: 'Guarulhos', area: 100_000,
                                  address: 'Avenida do Aeroporto, 1000', cep: '15000-000',
                                  description: 'Galpão destinado para cargas internacionais')
    supplier_a = Supplier.create!(corporate_name: 'Spark Industries Brasil LTDA', brand_name: 'Spark', 
                                  registration_number: '45097902000126', full_address: 'Torre da Industria, 1',
                                  city: 'Teresina', state: 'PI', email: 'industries@spark.com')
    ...
    product_a = ProductModel.create!(name: 'Produto A', weight: 1, width: 15, height: 20, depth: 30, supplier: supplier_a, sku: 'PRODUTO-A')
    product_b = ProductModel.create!(name: 'Produto B', weight: 1, width: 15, height: 20, depth: 30, supplier: supplier_b, sku: 'PRODUTO-B')
